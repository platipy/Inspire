...
from flask.ext.wtf import Form, TextField, PasswordField, validators, DateField
from flask.ext.wtf import SelectField, TextAreaField, SelectMultipleField
from flask.ext.wtf import widgets, RadioField, BooleanField
